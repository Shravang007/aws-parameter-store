...
variable "params" {
  default = [
    ...
    { name = "roboshop.dev.docdb.amqp_username", value = "roboshop", type = "String" },
    ...
    { name = "roboshop.dev.docdb.amqp_password", value = "roboshop123", type = "SecureString" },
    ...
    { name = "roboshop.dev.catalogue.docdb_endpoint", value = "docdb-prod.cluster-cbvsbeoyxek4.us-east-1.docdb.amazonaws.com", type = "String" },
    { name = "roboshop.dev.user.mongo_url", value = "mongodb://roboshop:roboshop123@docdb-dev.cluster-cbvsbeoyxek4.us-east-1.docdb.amazonaws.com:27017/user?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false", type = "SecureString" },
    { name = "roboshop.dev.user.docdb_endpoint", value = "docdb-prod.cluster-cbvsbeoyxek4.us-east-1.docdb.amazonaws.com", type = "String" },
